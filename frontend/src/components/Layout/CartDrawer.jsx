  ...
  return (
    ...
    >
      ...
      <div className="flex-grow p-4 overflow-y-auto">
        <h2 className="text-xal font-semibold mb-4">Your Cart</h2>
      ...
      <div className="p-4 bg-white sticky bottom-0">
        ...
        <p className="text-sm tracking-tighter text-gray-500 mt-2 text-center">Shipping, taxes abd discount codes calculated at checkout.</p>
      </div>
    </div>
  );
};
