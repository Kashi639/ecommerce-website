...
// @desc erge guest cart into user cart on login
// @access Private
      ...
      if (userCart) {
        ...
        guestCart.products.forEach((guestItem) => {
          ...
          if (productIndex > -1) {
            ...
            // add the guest item into the user cart
        ...
        // If the user has no existing cart, assign the guest cart to teh user
